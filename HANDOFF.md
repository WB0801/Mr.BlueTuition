...
这里的 UI Phase 只代表现有功能的界面与导航重构：UI Phase 4 重新设计的是既有功能开发 **Phase 6：成绩** 的操作体验，没有新增成绩业务能力，也没有修改数据库结构、学生资格规则、RPC、RLS 或 migration。

**UI Phase 5 尚未开始。** 不要继续开发 UI Phase 5、功能 Phase 9 或其他新功能，除非用户明确确认新的开发规格。
